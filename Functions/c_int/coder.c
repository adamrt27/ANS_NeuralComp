...
coder *initCoder(int L, int *s_list, int *L_s, int n_sym) {
...
void encodeCoder(coder *c, int *msg, int l_msg) {
    // encode the message
...
int encodeDecode(coder *c, int *msg, int l_msg) {
    // encode the message
...
int encodeDecodeWithInit(int L, int *s_list, int *L_s, int n_sym, int *msg, int l_msg) {
